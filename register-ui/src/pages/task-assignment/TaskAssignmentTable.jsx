...
const TaskAssignmentTable = ({ records, handleSelectRecord, selectedRecordId, isLoading }) => {
  return (
      ...
      <table className="min-w-full divide-y divide-gray-200">
        <thead className="bg-gray-50">
          <tr>
            ...
            <th className="px-6 py-3 text-left text-xs font-bold text-gray-600 uppercase tracking-wider">Empleado Asignado</th>
            <th className="px-6 py-3 text-left text-xs font-bold text-gray-600 uppercase tracking-wider">Tarea Asignada</th>
        ...
        <tbody className="bg-white divide-y divide-gray-200">
          ...
          {!isLoading && records.map((record) => (
            ...
            >
              ...
              <td className="px-6 py-4 whitespace-nowrap text-sm">{record.taskDescription}</td>
