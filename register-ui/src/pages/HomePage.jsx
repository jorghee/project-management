...
const subsystems = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/positions', label: 'Cargos' },
      { path: '/experience-levels', label: 'Niveles de Experiencia' },
  ...
  {
    name: 'Cálculos y factores (G4)',
    items: [
      { path: '/utility-factors', label: 'Factores de Utilidad' },
      { path: '/time-factors', label: 'Factores de Tiempo' },
      { path: '/complexities', label: 'Complejidad del proyecto' },
    ],
  },
];
